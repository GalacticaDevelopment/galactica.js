...
module.exports = class VOID {
  ...
  serverCount(message) {
  fetch(`https://galactica.ga/api/bots/stats`, {
        method: 'POST',
        headers: { 
  ...
  async search(id) {
  return await fetch(`https://galactica.ga/api/bots/${id}`, {
        method: 'GET'
    })
  ...
  async hasVoted(id) {
  return await fetch(`https://galactica.ga/api/bots/check/${id}`, {method: 'GET',headers: { 
